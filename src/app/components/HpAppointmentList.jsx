    ...
    <section role="region" aria-labelledby='appointment-header'>
      ...
      <ol className="list-none p-0 m-0">
        ...
        <li className="mb-10 flex gap-10" aria-labelledby='listItem-01'>
          ...
          <div className='w-4/5'>
            ...
            <div className="w-full flex justify-center">
              <img src="/images/AwaitingCert-Image@2x.png" alt="Awaiting Certification status" className="w-44" />
            </div>
          </div>
        </li>
        {/* Step 2: QMP Check-in */}
        <li className="mb-10 flex gap-10" aria-labelledby='listItem-02'>
          ...
          <div className='w-4/5'>
            <h3 id="listItem-02" className="text-xl font-bold text-primary mb-4">Check in with your QMP</h3>
        ...
        <li className="mb-10 flex gap-10" aria-labelledby='listItem-03'>
          ...
          <div className='w-4/5'>
            <h3 id="listItem-03" className="text-xl font-bold text-primary mb-4">Renewal or New Patient?</h3>
            ...
            <div className='w-full flex justify-center'>
              <ol className="list-none pl-0 mb-4">
                ...
                <li className="font-bold">**Don't forget to take advantage of new patient deals**</li>
              </ol>
            </div>
